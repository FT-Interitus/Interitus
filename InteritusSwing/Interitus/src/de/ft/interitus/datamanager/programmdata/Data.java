        ...
        if (!folder.exists()) {//Wenn der Programm-Ordner noch nicht exsitiert
            ...
            if (!recent.exists()) { //Wenn die Datei der letzten Projekte noch nicht exsisiert
                ...
                try {
                    ...
                    FileOutputStream stream = new FileOutputStream(tempfolder, false);
                ...
                try {
                    ...
                    FileInputStream re = new FileInputStream(new File(System.getProperty("user.home") + "/" + foldername + "/recent.json"));
                    FileOutputStream ins = new FileOutputStream(new File(System.getProperty("user.home") + "/" + foldername + "/recent.json"));

                    if (new String(re.readAllBytes()) == "") {
                        ins.write("{}".getBytes());
                        return;
                    }
                    ins.close();
