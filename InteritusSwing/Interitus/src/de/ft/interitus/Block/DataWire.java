...
public class DataWire {
    ...
    private void userLayoutMovment(){
        if((UIVar.DataWire[1][0]<=UIVar.DataWire[2][0] && (moving[0] || CheckMouse.isMouseover(UIVar.DataWire[1][0],UIVar.DataWire[1][1]-UIVar.DataWireMouseKollisionsFeld,UIVar.DataWire[2][0]-UIVar.DataWire[1][0],UIVar.DataWireMouseKollisionsFeld*2, true))) || (UIVar.DataWire[1][0]>UIVar.DataWire[2][0] && (moving[0] || CheckMouse.isMouseover(UIVar.DataWire[2][0],UIVar.DataWire[1][1]-UIVar.DataWireMouseKollisionsFeld,UIVar.DataWire[1][0]-UIVar.DataWire[2][0],UIVar.DataWireMouseKollisionsFeld*2, true)))){
            //TODO L Gdx.graphics.setSystemCursor(SystemCursor.VerticalResize);
            setCorsoronlyonce=true;
            if(Input.isButtonJustPressed(0)) {
                moving[0] = true;
            }
            if(Input.isButtonPressed(0) && moving[0]){
                if(UIVar.doonce) {
                    UIVar.merkpos.set(Input.getX(), Input.getY(), verschiebung_4_VertikaleInput);
                    UIVar.doonce=false;
                }
                verschiebung_4_VertikaleInput=(int)UIVar.merkpos.y-Input.getY()+(int)UIVar.merkpos.z;
            }else if(!Input.isButtonPressed(0)){
                UIVar.doonce=true;
                moving[0]=false;
            }
            ...
            //TODO L Gdx.graphics.setSystemCursor(SystemCursor.HorizontalResize);
            setCorsoronlyonce=true;
            if(Input.isButtonJustPressed(0)) {
                moving[1] = true;
            }
            if(Input.isButtonPressed(0)  && moving[1]){
                if(UIVar.doonce) {
                    UIVar.merkpos.set(Input.getX(), Input.getY(), verschiebung_2_HorizontaleInput);
                    UIVar.doonce=false;
                }
                verschiebung_2_HorizontaleInput=Input.getX()-(int)UIVar.merkpos.x+(int)UIVar.merkpos.z;
            }else if(!Input.isButtonPressed(0)){
                UIVar.doonce=true;
                moving[1]=false;
            }
            ...
            if(Input.isButtonPressed(0)  && moving[2]){
                if(UIVar.doonce) {
                    UIVar.merkpos.set(Input.getX(), Input.getY(), verschiebung_1_Horizontale);
                    UIVar.doonce=false;
                }
                verschiebung_1_Horizontale=(int)UIVar.merkpos.y-Input.getY()+(int)UIVar.merkpos.z;
            }else if(!Input.isButtonPressed(0)){
                UIVar.doonce=true;
                moving[2]=false;
            }
            ...
            if(Input.isButtonPressed(0)  && moving[3]){
                if(UIVar.doonce) {
                    UIVar.merkpos.set(Input.getX(),Input.getY(), verschiebung_3_HorizontaleOutput);
                    UIVar.doonce=false;
                }
                verschiebung_3_HorizontaleOutput=Input.getX()-(int)UIVar.merkpos.x+(int)UIVar.merkpos.z;
            }else if(!Input.isButtonPressed(0)){
                UIVar.doonce=true;
                moving[3]=false;
            }
            ...
            if(Input.isButtonPressed(0)  && moving[4]){
                if(UIVar.doonce) {
                    UIVar.merkpos.set(Input.getX(), Input.getY(), verschiebung_5_VertikaleInput);
                    UIVar.doonce=false;
                }
                verschiebung_5_VertikaleInput=(int)UIVar.merkpos.y-Input.getY()+(int)UIVar.merkpos.z;
            }else if(!Input.isButtonPressed(0)){
                UIVar.doonce=true;
                moving[4]=false;
            }
            ...
            if(setCorsoronlyonce) {
                //TODO L Gdx.graphics.setSystemCursor(SystemCursor.Arrow);
    ...
    public void draw() {
       ...
       input_y = param_input.getY();
           ...
           for(Block block: ProjectManager.getActProjectVar().blocks) {
               ...
               for(Parameter parameter:block.getBlocktype().getBlockParameter()) {
                   if(parameter!=this.getParam_input()&&!parameter.getParameterType().isOutput()&&parameter.getDatawire().size()!=1&&parameter.getParameterType().typ.iscompatible(this.getParam_input().getParameterType().typ)&&parameter.getBlock()!=this.getParam_input().getBlock()) {
                       ...
                       if(CheckKollision.checkpointwithobject(parameter.getX(),parameter.getY(), UIVar.parameter_width,UIVar.parameter_height,Unproject.unproject())&&Input.isButtonPressed(0)) {
        ...
        //TODO L     ProgrammingSpace.BlockshapeRenderer.setColor(this.getParam_input().getParameterType().getTyp().getWirecolor());
        ...
        //TODO L   ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[0][0], UIVar.DataWire[0][1], UIVar.DataWire[1][0], UIVar.DataWire[1][1],UIVar.thickness);//Verlängerung an input
     //TODO L    ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[1][0], UIVar.DataWire[1][1], UIVar.DataWire[2][0], UIVar.DataWire[2][1],UIVar.thickness);//input horizontal verlängerung
      //TODO L   ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[2][0], UIVar.DataWire[2][1], UIVar.DataWire[3][0], UIVar.DataWire[3][1], UIVar.thickness);//vertikale an input
       //TODO L  ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[3][0], UIVar.DataWire[3][1], UIVar.DataWire[4][0], UIVar.DataWire[4][1], UIVar.thickness);//Horizontale
      //TODO L   ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[4][0], UIVar.DataWire[4][1], UIVar.DataWire[5][0], UIVar.DataWire[5][1], UIVar.thickness);//Vertikale an output
     //TODO L    ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[5][0], UIVar.DataWire[5][1], UIVar.DataWire[6][0], UIVar.DataWire[6][1], UIVar.thickness);//output horizontal verlängerung
      //TODO L   ProgrammingSpace.BlockshapeRenderer.rectLine(UIVar.DataWire[6][0], UIVar.DataWire[6][1], UIVar.DataWire[7][0], UIVar.DataWire[7][1], UIVar.thickness);//Verlängerung an output
        ...
        if(ProjectManager.getActProjectVar().moveingdatawire==this) {
            ...
            if(Input.isButtonJustPressed(0)) {
                ...
                for (int i = 0; i < ProjectManager.getActProjectVar().visibleblocks.size(); i++) {
                    ...
                    if (CheckKollision.object(ProjectManager.getActProjectVar().visibleblocks.get(i).getX(), ProjectManager.getActProjectVar().visibleblocks.get(i).getY(), ProjectManager.getActProjectVar().visibleblocks.get(i).getW(), ProjectManager.getActProjectVar().visibleblocks.get(i).getH(), ProgrammingSpace.blockCamera.unproject_x(Input.getX()), ProgrammingSpace.blockCamera.unproject_y(Input.getY()), 1, 1)) {
                        counter++;
                    }
