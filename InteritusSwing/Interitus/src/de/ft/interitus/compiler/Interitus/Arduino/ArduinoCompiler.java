...
public class ArduinoCompiler implements Compiler {
    ...
    @Override
    public boolean compileandrun() throws JSONException {
    ...
    @Override
    public String getCompilerVersion() throws JSONException {
    ...
    private boolean compileandrun(JSONObject device) throws JSONException {
