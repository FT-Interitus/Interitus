...
package de.ft.interitus.UI_old.setup;
...
import de.ft.interitus.UI_old.setup.steps.generalSteps.Step1;
import de.ft.interitus.UI_old.setup.steps.generalSteps.Step2;
                ...
                public void changed(ChangeEvent event, Actor actor) {
                    ...
                    if (currentStep > 2) {
                        if (true) {
                            switch (currentStep) {
                                case 3:
                                    de.ft.interitus.UI_old.setup.steps.RaspberryPiSteps.Step3.close();
                                    break;
                                case 4:
                                    de.ft.interitus.UI_old.setup.steps.RaspberryPiSteps.Step4.close();
                                    break;
                                case 5:
                                    de.ft.interitus.UI_old.setup.steps.RaspberryPiSteps.Step5.close();
                    ...
                    if (currentStep > 2) {
                        ...
                        if (true) {
                            ...
                            switch (currentStep) {
                                case 3:
                                    de.ft.interitus.UI_old.setup.steps.RaspberryPiSteps.Step3.step3(content);
                                    break;
                                case 4:
                                    de.ft.interitus.UI_old.setup.steps.RaspberryPiSteps.Step4.step4(content);
                                    break;
                                case 5:
                                    de.ft.interitus.UI_old.setup.steps.RaspberryPiSteps.Step5.step5(content);
                                    break;
                            }
