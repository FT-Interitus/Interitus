...
public class InitNeoPixelController {
    ...
    static ProjectTypes type = new ProjectTypes(ProgrammingSpace.nativ, new NeoPixelController(), "Arduino-Neopixel-Projekt", blocks, new DefaultBlockGenerator(), new DefaultBlockUpdateGenerator(), new DefaultWireGenerator(), new DefaultWireNodeGenerator(), new DefaultSaveBlockGenerator(), new DefaultBlockVarGenerator(),null,null);
