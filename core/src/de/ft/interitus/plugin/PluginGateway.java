...
public class PluginGateway {
    ...
    private static ArrayList<Plugin> pluginprojekttypesplugins = new ArrayList<>();

    public static List<VisTable> pluginsettings = new ArrayList<>();
    private static ArrayList<Plugin> pluginsettingsplugins = new ArrayList<>();

    public static List<Menu> pluginMenubar = new ArrayList<>();
    private static ArrayList<Plugin> pluginMenubarplugins = new ArrayList<>();

    public static ArrayList<ShortCutChecker> pluginshortCutsChecker = new ArrayList<>();
    private static ArrayList<Plugin> pluginshortCutsCheckerplugins = new ArrayList<>();

    public static ArrayList<ShortCut> pluginshortCuts = new ArrayList<>();
    private static ArrayList<Plugin> pluginshortCutsplugins = new ArrayList<>();

    private static ArrayList<Plugin> themesplugins = new ArrayList<>();
