...
public class CheckKollision {
    ...
    public static boolean checkmousewithblock(Block block) {
        ...
        return object(block.getX(), block.getY(), block.getH(), block.getW(), (int) MainGame.viewport.unproject(new Vector3(Gdx.input.getX(), Gdx.input.getY(), 0)).x, (int) MainGame.viewport.unproject(new Vector3(Gdx.input.getX(), Gdx.input.getY(), 0)).y, mousesize, mousesize);
